******************************************************************************************************************************************************************************************************* 
***SYNTAX FOR "Associations of the Short Physical Performance Battery (SPPB) with adverse health outcomes in older adults: A 14-year follow-up from the English Longitudinal Study of Ageing (ELSA)"***
*******************************************************************************************************************************************************************************************************
...
* Model 11
mi estimate: mixed IADL c.totalSPPB_cons##c.wave##c.wave c.totalSPPB_cons#c.age_cons age_cons i.sex_cons i.eth_cons i.marital_cons i.employment_cons i.education_cons i.wealth_cons i.activity_cons bmic_cons zcog_cons depression_cons IADLw2_cons || idauniq: wave, pweight(w2xwgt)
...
* Model 6
melogit falls i.gait_cons wave age_cons i.sex_cons i.eth_cons i.marital_cons i.employment_cons i.education_cons i.wealth_cons i.activity_cons bmic_cons zcog_cons depression_cons i.fallsw2_cons || idauniq:, pweight(w2xwgt) or
